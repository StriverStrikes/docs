...
You can retrieve the recording URL by fetching the agent using the **Retrieve Agent** API.  
The `videoUrl` field contains a **pre-signed URL**, allowing you to stream or download the recording.
...
| **Feature**          | **Platform Captions**                       | **AI Transcription**                      |
|-----------------------|------------------------------------------|-----------------------------------------|
