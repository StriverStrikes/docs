...
<Tabs>
  ...
  -d '{
      ...
      "streaming": {
          "transcription": {
              "url": "wss://your-websocket-endpoint/transcription"
          },
          "media": {
              "audioUrl": "wss://your-websocket-endpoint/audio"
          }
      }
  }'
  ```
...
<ResponseField name="agentVideoOutput" type="object" optional>
  **Description**: Customize what appears in the agent's video feed during the meeting.     
  **Optional**: Yes

  - **resolution**: Must be 1600x900 pixels (16:9 aspect ratio)

  *Note*: Only static images are currently supported. The image must exactly match the required 1600x900 pixel resolution.
</ResponseField>
